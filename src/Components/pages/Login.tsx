...
const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-primary-dark">
            <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-sm dark:bg-primary-super-dark">
                <h2 className="text-2xl font-bold text-center mb-6 dark:text-white">Login</h2>
                <form onSubmit={handleLogin}>
                    <div className="mb-4">
                        <label className="block text-gray-700 mb-1 dark:text-white" htmlFor="email">Email</label>
                        <input
                            type="email"
                            id="email"
                            className="w-full px-4 py-2 border dark:border-white dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                            value={email}
                    ...
                    <div className="mb-6 relative">
                        <label className="block text-gray-700 mb-1 dark:text-white" htmlFor="password">Password</label>
                        <input
